...
export const logo=(compact=false,subtitle='MEASURABLE PROGRESS')=>`<span class="brand-symbol" aria-hidden="true"><svg viewBox="0 0 44 44"><path class="logo-orbit" d="M6 22c0-9 7-16 16-16s16 7 16 16-7 16-16 16S6 31 6 22Z"/><path class="logo-axis" d="M4 22h36M22 4v36"/><path class="logo-m" d="M12 30V14l10 10 10-10v16"/></svg></span>${compact?'':`<span class="brand-word"><b>MARKOVLAB</b><small>${subtitle}</small></span>`}`;
