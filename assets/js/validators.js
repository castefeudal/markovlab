...
export function normalizeImport(raw,validIds){
 ...
 if(Number(raw.version||1)>2)throw new Error('Unsupported version');
 const out={version:2,lang:raw.lang==='en'?'en':'ru',theme:allowedThemes.has(raw.theme)?raw.theme:'system',profile:{},favorites:[],history:[],snapshots:[],recents:[],onboardingDismissed:Boolean(raw.onboardingDismissed)};
