import * as legacy from './renderers.js?v=5.2.0-r1';
import { CALCULATORS, calculatorMap } from './calculators.js?v=5.2.0-r1';
import { REFERENCES } from './references.js?v=5.2.0-r1';
import { categories, evidenceLabels, methodLabels, l, t, formatNumber, formatUnit } from './i18n.js?v=5.2.0-r1';
import { icon, logo } from './icons.js?v=5.2.0-r1';
import { DOMAIN_CONTENT, WHEN_USEFUL, applyResultGuidance, confidenceFor, fieldHelp, relatedFor, visualizationType } from './content.js?v=5.2.0-r1';
import { searchCalculators as legacySearchFn } from './search.js?v=5.2.0-r1';
...
export function calculatorsPage(state,query='',favoritesOnly=false){
  const lang=state.lang,q=query.trim(),favoriteSet=favoritesOnly?new Set(state.favorites):null,list=legacySearch(query,favoriteSet).slice(0,q?12:CALCULATORS.length);
...
export function aboutPage(state){
  ...
  return legacy.aboutPage(state)
    .replace(/MARKOVLAB \/ 2\.0\.0/g,'MARKOVLAB / 5.2.0')
